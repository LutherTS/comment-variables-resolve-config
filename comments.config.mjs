...
export const resolvedConfigData = {
  "jsDoc": {
    "definitions": {
      ...
      "flattenConfigData": {
        "value": "Flattens the config's data property into a one-dimensional object of `COMMENT#COMMENT`-like keys and string values.",
      ...
      "normalize": {
        "value": "Normalizes a Comment Variables key segment.",
      ...
      "getComposedVariablesExclusivesFreeKeys": {
        "value": "Gets all Comment Variables keys from the data of a given config or variation that aren't marked to be exclusively used for composed variables.",
        "key": "JSDOC#DEFINITIONS#GETCOMPOSEDVARIABLESEXCLUSIVESFREEKEYS"
      },
      "removeVariantPrefixFromVariationKey": {
        "value": "Removes the variant segment of a Comment Variable key.",
      ...
      "resolveData": {
        "value": "Resolves the config's data or any provided variation data into information consumable by the Comment Variables ecosystem.",
        "key": "JSDOC#DEFINITIONS#RESOLVEDATA"
      }
    },
    "params": {
      "stringA": {
      ...
      "configDataD": {
        "value": "The config's data property, or any provided variation data. (Config or variation data at this time may still be `unknown`.)",
      ...
      "stringB": {
        "value": "The key segment to be normalized, notably for variants.",
      ...
      "isVariationData": {
        "value": "A boolean that decides to crop out the initial variant segments of composed variables exclusives keys when addressing variation data. (However, this function is only used for variation and fallback data at this time, so `isVariationData` is currently superfluous.)",
        "key": "JSDOC#PARAMS#ISVARIATIONDATA"
      },
      "variationKey": {
        "value": "The variation key that needs its variant segment prefix removed (such as going from `EN#COMMENT` to `COMMENT`).",
      ...
      "extracts": {
        "value": "The array that stores all the object string values related to the config, since those are to be exclusively used with the config's data. Includes their file paths and `SourceLocation` objects alongside their values.",
        "key": "JSDOC#PARAMS#EXTRACTS"
      },
      "isCoreResolve": {
        "value": "A boolean that decides whether or not `valueLocation` checks should be run as they should only be run when resolving `config.data`.",
        "key": "JSDOC#PARAMS#ISCORERESOLVE"
      }
    },
    "returns": {
      "escapeRegex": {
      ...
      "normalize": {
        "value": "The normalized key segment under a common algorith for the entire library.",
      ...
      "getComposedVariablesExclusivesFreeKeys": {
        "value": "All Comment Variables keys from the data of a given config or variation that aren't marked to be exclusively used for composed variables. This is to later ensure that all variations share the exact same keys for perfect versatility, or default to the fallback data suffixed by a mention of the name of their label.",
        "key": "JSDOC#RETURNS#GETCOMPOSEDVARIABLESEXCLUSIVESFREEKEYS"
      },
      "removeVariantPrefixFromVariationKey": {
        "value": "The variation key with its variant segment removed, akin to a Comment Variable key when `variations` are not in use.",
      ...
      "resolveData": {
        "value": "With a `{success: true}` object, all the information to be consumed by the Comment Variables CLI and the Comment Variables VS Code extension, namingly `originalFlattenedConfigData`, `aliases_flattenedKeys`, `flattenedConfigData`, `reversedFlattenedConfigData`, `keys_valueLocations`, `nonAliasesKeys_valueLocations`, `aliasesKeys_valueLocations`, `configDataResultsData`, `flattenedKeys_originalsOnly`, and probably more are the function evolves.",
        "key": "JSDOC#RETURNS#RESOLVEDATA"
      }
    },
    "constants": {
      "configKeyRegex": {
