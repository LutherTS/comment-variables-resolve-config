...
export const flattenedConfigPlaceholderRegexLocally = new RegExp(
  `${escapeRegex($COMMENT)}#(?!#)([\\p{Lu}\\p{Lo}\\p{Pd}\\p{Pc}\\p{N}#_]+)`,
  "u" // flattenedConfigPlaceholderRegex
); // same as flattenedConfigPlaceholderRegex but not globally
export const flattenedConfigPlaceholderRegex = new RegExp(
  `${escapeRegex($COMMENT)}#(?!#)([\\p{Lu}\\p{Lo}\\p{Pd}\\p{Pc}\\p{N}#_]+)`,
  "gu" // flattenedConfigPlaceholderGlobalRegex
